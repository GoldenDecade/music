...
<!--歌词-->
    ...
    <div class="music-bar" :class="{disable: !musicReady || !currentMusic.id}">
      ...
      <div class="music-music">
        ...
        <div class="music-bar-time" v-if="currentMusic.id">{{currentTime | format}} / {{currentMusic.duration | formatDuration}}</div>
      ...
      <!--<i class="bar-icon btn-comment" @click="modeChange"></i>-->
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      keyDown() {
        document.onkeydown = e => {// 键盘事件 keydown keypress keyup
          switch(e.ctrlKey && e.keyCode) {// e.ctrlKey指ctrl键被按下 e.keyCode 区分是哪个键
            case 32: // 播放暂停Ctrl + Space
              this.play();
              break;
            case 37: // 上一曲 Ctrl + Left
              this.prev();
              break;
            case 38:// 音量加 Ctrl + up
              ...
              break;
            case 39: // 下一曲 Ctrl + Right
              this.next();
              break;
            case 40: // 音量减 Ctrl + Down
